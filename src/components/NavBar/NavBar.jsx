        ...
        <div className='nav-container'>
            <div className='nav-bar'>
                ...
                <div className='dark-btn desktop-nav'>
                    <button
                        className='nav-item dark-item theme-toggle'
                        onClick={() => {
                            toggleTheme();
                            closeMenu();        // optional
                        }}
                ...
                <div className={`mobile-menu ${isOpen ? "open" : ""}`}>
                    {/* ... your mobile links ... */}
                    <NavLink to='/Portfolio' className={({ isActive }) => isActive ? "nav-link active mobile-link" : "nav-link mobile-link"} onClick={closeMenu}>
                        Portfolio
                    </NavLink>
                    <NavLink to='/About' className={({ isActive }) => isActive ? "nav-link active mobile-link" : "nav-link mobile-link"} onClick={closeMenu}>
                        About
                    </NavLink>
                    <NavLink to='/Contact' className={({ isActive }) => isActive ? "nav-link active mobile-link" : "nav-link mobile-link"} onClick={closeMenu}>
                        Contact
                    </NavLink>
